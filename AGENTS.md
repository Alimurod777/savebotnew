# AGENTS.md — Loyiha qoidalari va arxitekturasi

Bu fayl Codex AI uchun majburiy ko'rsatma. Har qanday o'zgartirish yoki qo'shimcha yozishdan OLDIN bu faylni o'qi va qat'iy amal qil.
...
**Yangi Codex sessiyasi boshlanganda:**
...
Bu fayl har xil Codex sessiyalari o'rtasida ma'lumot yo'qolishini oldini oladi.
...
```
**MUHIM:** `relay_uploader.upload_via_relay()` — bu funksiya HECH QACHON chaqirilmasin (AGENTS.md §19 ga qarang). Upload faqat UserUploadWorker yoki SessionManager orqali.
